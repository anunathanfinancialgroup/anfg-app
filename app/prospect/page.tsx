          ...
          <div className="px-6 py-5 space-y-4">
            ...
            <div className="rounded-xl border-2 border-slate-400 overflow-hidden">
              <div className="overflow-x-auto relative">
                <table className="min-w-full w-full text-sm" style={{ tableLayout: 'fixed', borderCollapse: 'separate', borderSpacing: '0', border: '1px solid #94a3b8' }}>
                        ...
                        return (
                          <th
                            ...
                            style={{ 
                              ...
                              borderRight: idx === 2 ? '2px solid #475569' : idx < 2 ? '1px solid #64748b' : '1px solid #94a3b8',
                              ...(isSticky ? { 
                                left: `${leftOffset}px`, 
                                zIndex: 30,
                                boxShadow: idx === 2 ? '3px 0 8px -2px rgba(0,0,0,0.25)' : 'none'
                              } : {})
                            }}
                  ...
                  <tbody>
                    {loading ? (
                      <tr>
                        <td colSpan={COLUMNS.length} className="px-3 py-6 text-center text-slate-500" style={{ border: '1px solid #94a3b8' }}>
                          Loading...
                        </td>
                      </tr>
                    ) : pageRows.length === 0 ? (
                          ...
                          >
                            ...
                            <td 
                              ...
                              style={{ 
                                ...
                                boxShadow: '3px 0 8px -2px rgba(0,0,0,0.25)'
                              }}
                            >
                              {p.spouse_name}
                            </td>
                            <td className="px-2 py-2 text-xs text-slate-700 truncate" style={{ width: `${columnWidths['relation_type']}px`, border: '1px solid #94a3b8' }}>{p.relation_type}</td>
                            <td className="px-2 py-2 text-xs text-slate-700 truncate" style={{ width: `${columnWidths['phone']}px`, border: '1px solid #94a3b8' }}>{p.phone}</td>
                            <td className="px-2 py-2 text-xs text-slate-700 truncate" style={{ width: `${columnWidths['city']}px`, border: '1px solid #94a3b8' }}>{p.city}</td>
                            <td className="px-2 py-2 text-xs text-slate-700 truncate" style={{ width: `${columnWidths['state']}px`, border: '1px solid #94a3b8' }}>{p.state}</td>
                            <td className={`px-2 py-2 text-xs truncate ${p.top25 === 'Yes' || p.top25 === 'Y' ? 'text-emerald-700 font-semibold' : 'text-slate-700'}`} style={{ width: `${columnWidths['top25']}px`, border: '1px solid #94a3b8' }}>{yesNoNormalize(p.top25)}</td>
                            <td className="px-2 py-2 text-xs text-slate-600 truncate" style={{ width: `${columnWidths['immigration']}px`, border: '1px solid #94a3b8' }}>{p.immigration}</td>
                            <td className={`px-2 py-2 text-xs truncate ${p.age25plus === 'Yes' || p.age25plus === 'Y' ? 'text-emerald-700 font-semibold' : 'text-slate-700'}`} style={{ width: `${columnWidths['age25plus']}px`, border: '1px solid #94a3b8' }}>{yesNoNormalize(p.age25plus)}</td>
                            <td className={`px-2 py-2 text-xs truncate ${p.married === 'Yes' || p.married === 'Y' ? 'text-emerald-700 font-semibold' : 'text-slate-700'}`} style={{ width: `${columnWidths['married']}px`, border: '1px solid #94a3b8' }}>{yesNoNormalize(p.married)}</td>
                            <td className={`px-2 py-2 text-xs truncate ${p.children === 'Yes' || p.children === 'Y' ? 'text-emerald-700 font-semibold' : 'text-slate-700'}`} style={{ width: `${columnWidths['children']}px`, border: '1px solid #94a3b8' }}>{yesNoNormalize(p.children)}</td>
                            <td className={`px-2 py-2 text-xs truncate ${p.homeowner === 'Yes' || p.homeowner === 'Y' ? 'text-emerald-700 font-semibold' : 'text-slate-700'}`} style={{ width: `${columnWidths['homeowner']}px`, border: '1px solid #94a3b8' }}>{yesNoNormalize(p.homeowner)}</td>
                            <td className={`px-2 py-2 text-xs truncate ${p.good_career === 'Yes' || p.good_career === 'Y' ? 'text-emerald-700 font-semibold' : 'text-slate-700'}`} style={{ width: `${columnWidths['good_career']}px`, border: '1px solid #94a3b8' }}>{yesNoNormalize(p.good_career)}</td>
                            <td className={`px-2 py-2 text-xs truncate ${p.income_60k === 'Yes' || p.income_60k === 'Y' ? 'text-emerald-700 font-semibold' : 'text-slate-700'}`} style={{ width: `${columnWidths['income_60k']}px`, border: '1px solid #94a3b8' }}>{yesNoNormalize(p.income_60k)}</td>
                            <td className={`px-2 py-2 text-xs truncate ${p.dissatisfied === 'Yes' || p.dissatisfied === 'Y' ? 'text-emerald-700 font-semibold' : 'text-slate-700'}`} style={{ width: `${columnWidths['dissatisfied']}px`, border: '1px solid #94a3b8' }}>{yesNoNormalize(p.dissatisfied)}</td>
                            <td className={`px-2 py-2 text-xs truncate ${p.ambitious === 'Yes' || p.ambitious === 'Y' ? 'text-emerald-700 font-semibold' : 'text-slate-700'}`} style={{ width: `${columnWidths['ambitious']}px`, border: '1px solid #94a3b8' }}>{yesNoNormalize(p.ambitious)}</td>
                            <td className="px-2 py-2 text-xs text-slate-600 truncate" style={{ width: `${columnWidths['contact_date']}px`, border: '1px solid #94a3b8' }}>{p.contact_date}</td>
                            <td className="px-2 py-2 text-xs text-slate-900 font-medium truncate" style={{ width: `${columnWidths['result']}px`, border: '1px solid #94a3b8' }}>{p.result}</td>
                            <td className="px-2 py-2 text-xs text-slate-700 truncate" style={{ width: `${columnWidths['next_steps']}px`, border: '1px solid #94a3b8' }}>{p.next_steps}</td>
                          </tr>
                        );
                      })
                    )}
